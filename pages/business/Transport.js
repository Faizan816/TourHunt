...
export default function Transport() {
  ...
  const [transportType, setTransportType] = useState(transports[0]);
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      await axios.post("http://127.0.0.1:8000/registerTransport", {
        userId: userId,
        name: Compname,
        businessName,
      ...
      toast({
        description:
          "Registeration submitted successfully! You will be notified when it has been approved by the admin.",
        status: "success",
        duration: 5000,
        position: "top",
        isClosable: true,
          ...
          <div className="row">
            <div className="col-12 ">
              <div className="padding">
                <div className="title">
                  <h1 className="heading">Transport Registration </h1>
                </div>
